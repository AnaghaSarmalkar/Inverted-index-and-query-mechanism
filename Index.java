...
//  MAPPER CLASS WHICK TAKES LINE OFFSET AND TEXL LINE AS INPUT KEY VALUE PAIRS AND GIVES TEXT AND TEXT AS OUTPUT
  public static class Map extends Mapper<LongWritable, Text, Text, Text> {
//    private final static IntWritable one = new IntWritable(1);
    private Text word = new Text();
    private long numRecords = 0;   
//    CHECK PATTERN TO SPLIT WORDS
...
//      USE ARRAYLIST TO STORE DOCUMENT NAMES FOR WORDS
      ArrayList<String> plist = new ArrayList<String>();
      for (Text doc : docs) {
    	  String docu = doc.toString();
//    	  AVOIDS DUPLICATE ENTRIES OF DOCUMENT NAMES FOR THE SAME WORDS
    	  if (!plist.contains(docu)) {
    		plist.add(docu);
//    		sb.append(doc+"+");
    	}
      }
